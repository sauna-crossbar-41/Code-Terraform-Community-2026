...
# 🎮 Code: Terraform — Community Edition

**Terraform alien worlds in this standalone Community Edition build**
...
Code: Terraform is a strategy and simulation game in which players transform hostile planets into habitable worlds through resource management, technology research, and ecological engineering. This Community Edition is a standalone build of the complete game, packaged as a self-contained installer. It includes all released content and runs offline with no additional software required.

This build is for strategy and simulation players who want a self-contained, offline version of the complete game.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/868160/8e8aef331e6c4bc3f7e699b2e58c4ebb9de0d321/ss_8e8aef331e6c4bc3f7e699b2e58c4ebb9de0d321.1920x1080.jpg?t=1788973129" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/868160/2e35af8d8fdebd92d73958ef6627169bfa07f018/ss_2e35af8d8fdebd92d73958ef6627169bfa07f018.1920x1080.jpg?t=1788973129" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/868160/90a6f168d12c8ccf87a38b395411fd704a428a2a/ss_90a6f168d12c8ccf87a38b395411fd704a428a2a.1920x1080.jpg?t=1788973129" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🌍 **Planetary Terraforming** — Adjust atmosphere, temperature, water levels, and biomass across diverse planets.
- 🔬 **Technology Tree** — Research over 120 technologies spanning energy, ecology, and construction.
- 🏗️ **Base Building** — Construct and expand surface habitats, mines, and orbital infrastructure.
- 📊 **Simulation Depth** — Interdependent planetary systems react dynamically to every intervention.
- 🧭 **Campaign and Sandbox** — Play a structured 12-mission campaign or open-ended sandbox mode.
- 🗂️ **Complete Content** — Includes all official DLC packs and post-launch updates.
- 🔌 **Offline Play** — Full single-player experience with no storefront required.
- 🖥️ **Modding Support** — Load community mods and custom planet scenarios from the local mods folder.
- 💾 **Save Management** — Multiple save slots with autosave and manual export options.
- 🕹️ **Controller Support** — Full input remapping and gamepad compatibility.

- **Compression:** Lossless
- **Install Time:** ~4 minutes on SSD, ~12 minutes on HDD
- **Recoding:** none
- **Selective Download:** Not available — all content included by default

---

## 📦 DLCs Included

- Code: Terraform — Ocean Worlds
- Code: Terraform — Volcanic Frontier
- Code: Terraform — Orbital Expansion
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GTX 1050 Ti / AMD Radeon RX 560, 4 GB VRAM | NVIDIA RTX 2060 / AMD RX 5600 XT, 6 GB VRAM |
| **Storage** | 14 GB available space | 14 GB SSD |
| **Additional** | DirectX 11 compatible sound card | SSD storage for faster load times |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Code:Terraform\Saved`
